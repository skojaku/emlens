.. emlens documentation master file, created by
   sphinx-quickstart on Tue Jan 26 16:30:04 2021.
   You can adapt this file completely to your liking, but it should at least
   contain the root `toctree` directive.

Emlens: A lightweight toolbox for analyzing embedding
=====================================================
...
This package is still under active development. If you have issues and feature request, please raise them through github issue `Stack Overflow <https://github.com/skojaku/emlens>`_.. 
